...
#pragma region Shaders
	Shader g_shader{ "./Shaders/Deferred/g_buffer.vs", "./Shaders/Deferred/g_buffer.fs" };
	Shader lighting_shader{ "./Shaders/Deferred/deferred_shading.vs", "./Shaders/Deferred/deferred_shading.fs" };
	Shader lightBox_shader{ "./Shaders/Deferred/light_box.vs", "./Shaders/Deferred/light_box.fs" };
	Shader debug_shader{ "./Shaders/Deferred/fbo_debug.vs", "./Shaders/Deferred/fbo_debug.fs" };
