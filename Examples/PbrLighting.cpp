...
#pragma region Models
	Model ball{ "./Models/ball/ball.obj" ,false };
...
#pragma endregion Light
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			Shader new_shader{ "./Shaders/PbrLighting/pbr.vs", "./Shaders/PbrLighting/pbr.fs" };
			shader = new_shader;
			reload_shader = false;
		}
		...
		//lightPos += glm::vec3(0.1 * cos(glfwGetTime()), 0.1 * sin(glfwGetTime()), 0.0f);
